...
struct FoodTypeData {
    ...
    let data: [FoodType] = [
        ...
        FoodType(categoryId: 1, typeId: "105", typeName: "紅蘿蔔", typeIcon: "carrot", isDeletable: false),
        FoodType(categoryId: 1, typeId: "106", typeName: "蘆筍", typeIcon: "asparagus", isDeletable: false),
        FoodType(categoryId: 1, typeId: "107", typeName: "茄子", typeIcon: "eggplant", isDeletable: false),
        FoodType(categoryId: 1, typeId: "108", typeName: "青椒", typeIcon: "green-pepper", isDeletable: false),
        FoodType(categoryId: 1, typeId: "109", typeName: "菠菜", typeIcon: "spinach", isDeletable: false),
        FoodType(categoryId: 1, typeId: "110", typeName: "番茄", typeIcon: "tomato", isDeletable: false),
        ...
        FoodType(categoryId: 3, typeId: "303", typeName: "豆類", typeIcon: "bean", isDeletable: false),
        FoodType(categoryId: 3, typeId: "304", typeName: "起士", typeIcon: "cheese", isDeletable: false),
        FoodType(categoryId: 3, typeId: "305", typeName: "蛋", typeIcon: "egg", isDeletable: false),
        FoodType(categoryId: 3, typeId: "306", typeName: "雞肉", typeIcon: "chicken", isDeletable: false),
        FoodType(categoryId: 3, typeId: "307", typeName: "香腸", typeIcon: "sausage", isDeletable: false),
        FoodType(categoryId: 3, typeId: "308", typeName: "蝦", typeIcon: "shrimp", isDeletable: false),
